...
import { SceneSoundEffectSelectButton } from "@/features/scene";
...
export const StoryboardSceneSoundEffectList: FC<Props> = ({
    projectId,
    sceneId,
}) => {
    ...
    const addNewRoute = getPath("PROJECT_VIDEO_STORYBOARD_SCENE_SOUND_NEW", {
        projectId: projectId,
        sceneId: sceneId,
    });
                ...
                <ScrollArea scrollbars="horizontal">
                        ...
                        appendItem={
                            <>
                                ...
                                <CardList.Item size="150px">
                                    <FileCard
                                        file={null}
                                        active={null === scene?.sound_effect_id}
                                        actionButton={
                                            <SceneSoundEffectSelectButton
                                                scene={scene}
                                            >
                    ...
                    >
                        {(file) => (
                            <FileCard
                                file={file}
                                active={file.id === scene?.sound_effect_id}
                                actionButton={
                                    <SceneSoundEffectSelectButton scene={scene}>
                                        {(handleClick, isPending) => (
                                            <CheckboxButton
                                                onClick={() => {
                                                    handleClick(file);
